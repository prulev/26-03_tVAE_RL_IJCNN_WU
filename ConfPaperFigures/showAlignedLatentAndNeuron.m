...
dataIndex = dataIndex(1:2000);  % original: 1:2000
...
temp = load(['results/' fileName, '_RL_', num2str(test_fold), '.mat']);
...
cons.pre       = temp.pOutputTest'; 
cons.spk       = temp.spkOutPredictTest';   % here use cons to store RL_with_vanilla_VAE
cons.movements = temp.motor_perform_test;
